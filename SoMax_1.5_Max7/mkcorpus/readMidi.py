...
class SomaxMidiParser(MidiOutStream):
    ...
    def get_matrix(self):
        """ Returns the midi file parsed as a note matrix.

        :return: N-by-8 list of lists, where each row represent a note event and each column represent the following values:
